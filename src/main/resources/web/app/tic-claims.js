...
export class TicClaims extends LitElement {
    ...
    _fetchClaims(){
        fetch('/api/claims').then(response => {
                                    if (!response.ok) {
        ...
        return html`
                    ...
                    <div class="claim">
                        ...
                        <div class="claimSummary">
                            <vaadin-split-layout>
                                ...
                                <detail-content class="claimSummaryRight">
                                    ...
                                    <span>${this._selectedClaim.time}</span>

                                    <h3>Location of event</h3>
                                    <span>${this._selectedClaim.location}</span>
                        ...
                        <vaadin-details summary="Original claim content">
                            <div><b>Subject: </b>${this._selectedClaim.subject}</div>
                            <div>
                                ${unsafeHTML(this._selectedClaim.body)}
                            </div>
                        </vaadin-details>
    ...
    _renderClaims(){
        return html`<div class="claimsList">
                        <vaadin-grid 
                            ...
                            <vaadin-grid-sort-column path="claimId" auto-width></vaadin-grid-sort-column>
                            <vaadin-grid-sort-column path="policyNumber" header="Policy Number" auto-width></vaadin-grid-sort-column>
                            <vaadin-grid-sort-column path="subject" header="Subject" auto-width></vaadin-grid-sort-column>
                            <vaadin-grid-sort-column path="time" header="Date" auto-width></vaadin-grid-sort-column>
                        </vaadin-grid>
                        <vaadin-upload target="/api/claims" @upload-success="${(e) => this._fileUploaded(e)}"></vaadin-upload>
                    </div>`;
    }
